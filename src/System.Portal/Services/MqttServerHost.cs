...
{
    public class MqttServerHost : IHostedService
    {
        private Socket workSocket;
        private readonly ILogger<MqttServerHost> logger;

        public MqttServerHost(ILogger<MqttServerHost> logger)
        {
        ...
        {
            workSocket.Bind(new IPEndPoint(IPAddress.Any, 15002));
